...
float var10 <- date('2000-01-01') - date('2010-01-02'); // var10 equals 86400
``` 
...
point var17 <- {1, 2} - {4, 5}; // var17 equals {-3.0, -3.0}
``` 
...
point var24 <- {1, 2} - 4.5; // var24 equals {-3.5, -2.5, -4.5} 
point var25 <- {1, 2} - 4; // var25 equals {-3.0,-2.0,-4.0}
``` 
...
date var6 <- date('2000-01-01') + 200; // var6 equals date('2000-01-01')
``` 
...
geometry var17 <- circle(5) + 5; // var17 equals circle(10)
``` 
...
geometry var21 <- circle(5) + (5,32); // var21 equals circle(10)
``` 
