...
float var5 <- date('2000-01-01') - date('2010-01-02'); // var5 equals 86400
``` 
...
geometry var6 <- rectangle(10,10) - [circle(2), square(2)]; // var6 equals rectangle(10,10) - (circle(2) + square(2))
``` 
