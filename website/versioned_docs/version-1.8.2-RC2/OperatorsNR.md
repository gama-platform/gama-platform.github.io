...
**See also:** [weighted_means_DM](OperatorsSZ#weighted_means_dm), [electre_DM](OperatorsDH#electre_dm), [evidence_theory_DM](OperatorsDH#evidence_theory_dm), 
...
**See also:** [around](OperatorsAA#around), [circle](OperatorsBC#circle), [cone](OperatorsBC#cone), [line](OperatorsIM#line), [link](OperatorsIM#link), [norm](OperatorsNR#norm), [point](OperatorsNR#point), [polygon](OperatorsNR#polygon), [polyline](OperatorsNR#polyline), [square](OperatorsSZ#square), [triangle](OperatorsSZ#triangle), 
...
**See also:** [replace](OperatorsNR#replace), 
...
**See also:** [restore_simulation_from_file](OperatorsNR#restore_simulation_from_file), 
...
**See also:** [restore_simulation](OperatorsNR#restore_simulation), 
...
**See also:** [binomial](OperatorsBC#binomial), [gamma_rnd](OperatorsDH#gamma_rnd), [gauss_rnd](OperatorsDH#gauss_rnd), [lognormal_rnd](OperatorsIM#lognormal_rnd), [poisson](OperatorsNR#poisson), [skew_gauss](OperatorsSZ#skew_gauss), [truncated_gauss](OperatorsSZ#truncated_gauss), [weibull_rnd](OperatorsSZ#weibull_rnd), 
...
**See also:** [round](OperatorsNR#round), [int](OperatorsIM#int), [with_precision](OperatorsSZ#with_precision), 
...
**See also:** [columns_list](OperatorsBC#columns_list), 
