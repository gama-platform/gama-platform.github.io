...
#### Result: 
Send the given image to the websocket in Base64 using the given format.
Send the given image to the websocket using Base64 assuming the format is png.
...
#### Result: 
Serializes any object/agent/simulation into a string, using the `binary` format
...
**See also:** [to_json](OperatorsSZ#to_json), [to_gaml](OperatorsSZ#to_gaml), 
...
**See also:** [is_simulation](OperatorsIM#is_simulation), 
...
**See also:** [cos](OperatorsBC#cos), [tan](OperatorsSZ#tan), [cos_rad](OperatorsBC#cos_rad), [asin](OperatorsAA#asin), 
...
**See also:** [binomial](OperatorsBC#binomial), [gamma_rnd](OperatorsDH#gamma_rnd), [gauss_rnd](OperatorsDH#gauss_rnd), [lognormal_rnd](OperatorsIM#lognormal_rnd), [poisson](OperatorsNR#poisson), [rnd](OperatorsNR#rnd), [truncated_gauss](OperatorsSZ#truncated_gauss), [weibull_rnd](OperatorsSZ#weibull_rnd), [gauss](OperatorsDH#gauss), 
...
**See also:** [around](OperatorsAA#around), [circle](OperatorsBC#circle), [cone](OperatorsBC#cone), [line](OperatorsIM#line), [link](OperatorsIM#link), [norm](OperatorsNR#norm), [point](OperatorsNR#point), [polygon](OperatorsNR#polygon), [polyline](OperatorsNR#polyline), [rectangle](OperatorsNR#rectangle), [triangle](OperatorsSZ#triangle), [cylinder](OperatorsBC#cylinder), [plan](OperatorsNR#plan), [ellipse](OperatorsDH#ellipse), [polyhedron](OperatorsNR#polyhedron), [sphere](OperatorsSZ#sphere), [cone3D](OperatorsBC#cone3d), [teapot](OperatorsSZ#teapot), [squircle](OperatorsSZ#squircle), [elliptical_arc](OperatorsDH#elliptical_arc), [cross](OperatorsBC#cross), [box](OperatorsBC#box), [geometry_collection](OperatorsDH#geometry_collection), [pyramid](OperatorsNR#pyramid), [curve](OperatorsBC#curve), [arc](OperatorsAA#arc), 
...
**See also:** [mul](OperatorsIM#mul), [mean](OperatorsIM#mean), 
...
**See also:** [cos](OperatorsBC#cos), [sin](OperatorsSZ#sin), [cos_rad](OperatorsBC#cos_rad), [atan](OperatorsAA#atan), 
...
#### Possible uses: 
  * **`to_absolute_path`** (`string`) --->  `string` 

#### Result: 
Transforms a relative path into an absolute path. If the path is already absolute doesn't transform it.
...
### `to_binary`
   Same signification as [serialize](OperatorsSZ#serialize)
...
**See also:** [distance_between](OperatorsDH#distance_between), [distance_to](OperatorsDH#distance_to), [direction_between](OperatorsDH#direction_between), [path_between](OperatorsNR#path_between), [path_to](OperatorsNR#path_to), 
...
**See also:** [rotated_by](OperatorsNR#rotated_by), [translated_by](OperatorsSZ#translated_by), 
...
**See also:** [rotated_by](OperatorsNR#rotated_by), [transformed_by](OperatorsSZ#transformed_by), 
...
**See also:** [around](OperatorsAA#around), [circle](OperatorsBC#circle), [cone](OperatorsBC#cone), [line](OperatorsIM#line), [link](OperatorsIM#link), [norm](OperatorsNR#norm), [point](OperatorsNR#point), [polygon](OperatorsNR#polygon), [polyline](OperatorsNR#polyline), [rectangle](OperatorsNR#rectangle), [square](OperatorsSZ#square), [cylinder](OperatorsBC#cylinder), [plan](OperatorsNR#plan), [cube](OperatorsBC#cube), [ellipse](OperatorsDH#ellipse), [polyhedron](OperatorsNR#polyhedron), [sphere](OperatorsSZ#sphere), [cone3D](OperatorsBC#cone3d), [teapot](OperatorsSZ#teapot), [squircle](OperatorsSZ#squircle), [elliptical_arc](OperatorsDH#elliptical_arc), [cross](OperatorsBC#cross), [box](OperatorsBC#box), [hexagon](OperatorsDH#hexagon), [geometry_collection](OperatorsDH#geometry_collection), [curve](OperatorsBC#curve), [arc](OperatorsAA#arc), 
...
#### Possible uses: 
  ...
  * `list<geometry>` **`triangulate`** `float` --->  `list<geometry>`
  * **`triangulate`** (`list<geometry>` , `float`) --->  `list<geometry>`
...
A list of geometries (triangles) corresponding to the Delaunay triangulation computed from the list of polylines with the given tolerance for the triangulation
...
list<geometry> var3 <- triangulate([line([{0,50},{100,50}]), line([{50,0},{50,100}], 0.01)); // var3 equals the list of geometries (triangles) corresponding to the Delaunay triangulation of the geometry of the agent applying the operator with the a tolerance of 0.01 for the triangulation. 
...
list<geometry> var5 <- triangulate(self,0.1, 1.0, true); // var5 equals the list of geometries (triangles) corresponding to the Delaunay triangulation of the geometry of the agent applying the operator.
```
...
**See also:** [binomial](OperatorsBC#binomial), [gamma_rnd](OperatorsDH#gamma_rnd), [gauss_rnd](OperatorsDH#gauss_rnd), [lognormal_rnd](OperatorsIM#lognormal_rnd), [poisson](OperatorsNR#poisson), [rnd](OperatorsNR#rnd), [skew_gauss](OperatorsSZ#skew_gauss), [weibull_rnd](OperatorsSZ#weibull_rnd), [gamma_trunc_rnd](OperatorsDH#gamma_trunc_rnd), [weibull_trunc_rnd](OperatorsSZ#weibull_trunc_rnd), [lognormal_trunc_rnd](OperatorsIM#lognormal_trunc_rnd), [gauss](OperatorsDH#gauss), 
...
**See also:** [compress](OperatorsBC#compress), 
...
**See also:** [inter](OperatorsIM#inter), [+](OperatorsAA#+), 
...
**See also:** [lower_case](OperatorsIM#lower_case), [capitalize](OperatorsBC#capitalize), 
...
**See also:** [path_between](OperatorsNR#path_between), 
...
**See also:** [mean](OperatorsIM#mean), [median](OperatorsIM#median), 
...
**See also:** [binomial](OperatorsBC#binomial), [gamma_rnd](OperatorsDH#gamma_rnd), [gauss_rnd](OperatorsDH#gauss_rnd), [lognormal_rnd](OperatorsIM#lognormal_rnd), [poisson](OperatorsNR#poisson), [rnd](OperatorsNR#rnd), [skew_gauss](OperatorsSZ#skew_gauss), [truncated_gauss](OperatorsSZ#truncated_gauss), [weibull_trunc_rnd](OperatorsSZ#weibull_trunc_rnd), [gamma_density](OperatorsDH#gamma_density), [lognormal_density](OperatorsIM#lognormal_density), 
...
**See also:** [weibull_rnd](OperatorsSZ#weibull_rnd), [gamma_trunc_rnd](OperatorsDH#gamma_trunc_rnd), [lognormal_trunc_rnd](OperatorsIM#lognormal_trunc_rnd), [truncated_gauss](OperatorsSZ#truncated_gauss), [exp_rnd](OperatorsDH#exp_rnd), 
...
**See also:** [first_with](OperatorsDH#first_with), [last_with](OperatorsIM#last_with), [with_min_of](OperatorsSZ#with_min_of), [group_by](OperatorsDH#group_by), [with_max_of](OperatorsSZ#with_max_of), 
...
#### Possible uses: 
  * `emotion` **`with_about`** `predicate` --->  `emotion`
  * **`with_about`** (`emotion` , `predicate`) --->  `emotion` 
...
#### Possible uses: 
  * `social_link` **`with_agent`** `agent` --->  `social_link`
  * **`with_agent`** (`social_link` , `agent`) --->  `social_link` 
...
#### Possible uses: 
  * `emotion` **`with_agent_cause`** `agent` --->  `emotion`
  * **`with_agent_cause`** (`emotion` , `agent`) --->  `emotion` 
...
### `with_alpha`
   Same signification as [rgb](OperatorsNR#rgb)
...
#### Possible uses: 
  * `emotion` **`with_decay`** `float` --->  `emotion`
  * **`with_decay`** (`emotion` , `float`) --->  `emotion` 
...
#### Possible uses: 
  * `social_link` **`with_dominance`** `float` --->  `social_link`
  * **`with_dominance`** (`social_link` , `float`) --->  `social_link` 
...
#### Possible uses: 
  * `social_link` **`with_familiarity`** `float` --->  `social_link`
  * **`with_familiarity`** (`social_link` , `float`) --->  `social_link` 
...
#### Possible uses: 
  * `emotion` **`with_intensity`** `float` --->  `emotion`
  * **`with_intensity`** (`emotion` , `float`) --->  `emotion` 
...
#### Possible uses: 
  * `social_link` **`with_liking`** `float` --->  `social_link`
  * **`with_liking`** (`social_link` , `float`) --->  `social_link` 
...
**See also:** [round](OperatorsNR#round), 
...
#### Possible uses: 
  * `social_link` **`with_solidarity`** `float` --->  `social_link`
  * **`with_solidarity`** (`social_link` , `float`) --->  `social_link` 
...
#### Possible uses: 
  * `social_link` **`with_trust`** `float` --->  `social_link`
  * **`with_trust`** (`social_link` , `float`) --->  `social_link` 
...
#### Possible uses: 
  * `predicate` **`with_truth`** `bool` --->  `predicate`
  * **`with_truth`** (`predicate` , `bool`) --->  `predicate` 
...
**See also:** [is_xml](OperatorsIM#is_xml), 
...
**See also:** [or](OperatorsNR#or), [and](OperatorsAA#and), [!](OperatorsAA#!), 
...
### `zip`
   Same signification as [compress](OperatorsBC#compress)
