...
[Exceptions](https://github.com/gama-platform/gama/tree/GAMA_1.9.2/msi.gama.core/src/msi/gama/runtime/exceptions) in GAMA
...
Main class for debug is in ummisco.gama.dev.utils : [DEBUG](https://github.com/gama-platform/gama/tree/GAMA_1.9.2/ummisco.gama.annotations/src/ummisco/gama/dev/utils) 
...
1. Randomness in Gama: [msi.gama.util.random](https://github.com/gama-platform/gama/tree/GAMA_1.9.2/msi.gama.core/src/msi/gama/util/random)
