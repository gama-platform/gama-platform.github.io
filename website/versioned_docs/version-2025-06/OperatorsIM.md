...
**See also:** [out_edges_of](OperatorsNR#out_edges_of), [edge_between](OperatorsDH#edge_between), 
...
**See also:** [at](OperatorsAA#at), [last_index_of](OperatorsIM#last_index_of), [all_indexes_of](OperatorsAA#all_indexes_of), 
...
**See also:** [rotation_composition, normalized_rotation](OperatorsSZ#rotation_composition, normalized_rotation), [rotation_composition](OperatorsNR#rotation_composition), 
...
**See also:** [at](OperatorsAA#at), [index_of](OperatorsIM#index_of), [last_index_of](OperatorsIM#last_index_of), [all_indexes_of](OperatorsAA#all_indexes_of), 
...
**See also:** [exp](OperatorsDH#exp), [log](OperatorsIM#log), 
...
#### Examples: 
``` 
float var0 <- log(100, 100); // var0 equals 1.0 
float var1 <- log(100.0, 100.0); // var1 equals 1.0 
float var2 <- log(10); // var2 equals 1.0 
float var3 <- log(1); // var3 equals 0.0 
float var4 <- log(100, 100.0); // var4 equals 1.0 
float var5 <- log(100.0, 100); // var5 equals 1.0
```
...
**See also:** [binomial](OperatorsBC#binomial), [gamma_rnd](OperatorsDH#gamma_rnd), [gauss_rnd](OperatorsDH#gauss_rnd), [poisson](OperatorsNR#poisson), [rnd](OperatorsNR#rnd), [skew_gauss](OperatorsSZ#skew_gauss), [truncated_gauss](OperatorsSZ#truncated_gauss), [weibull_rnd](OperatorsSZ#weibull_rnd), [lognormal_trunc_rnd](OperatorsIM#lognormal_trunc_rnd), [exp_density](OperatorsDH#exp_density), [exp_rnd](OperatorsDH#exp_rnd), [gamma_density](OperatorsDH#gamma_density), [weibull_density](OperatorsSZ#weibull_density), 
...
**See also:** [upper_case](OperatorsSZ#upper_case), [capitalize](OperatorsBC#capitalize), 
...
**See also:** [min_of](OperatorsIM#min_of), [mean_of](OperatorsIM#mean_of), [variance_of](OperatorsSZ#variance_of), [product_of](OperatorsNR#product_of), 
...
**See also:** [mean](OperatorsIM#mean), [harmonic_mean](OperatorsDH#harmonic_mean), [variance](OperatorsSZ#variance), [geometric_mean](OperatorsDH#geometric_mean), 
...
**See also:** [max_of](OperatorsIM#max_of), [mean_of](OperatorsIM#mean_of), [variance_of](OperatorsSZ#variance_of), [product_of](OperatorsNR#product_of), 
