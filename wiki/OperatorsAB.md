...
float var11 <- date('2000-01-01') - date('2010-01-02'); // var11 equals 86400
``` 
...
date var16 <- date('2000-01-01') - 200; // var16 equals date('2000-01-01')
``` 
...
string var16 <- "hello " + 12; // var16 equals "hello 12"
``` 
