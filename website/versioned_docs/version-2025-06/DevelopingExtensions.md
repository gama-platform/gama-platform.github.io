...
The extension mechanism relies on two complementary techniques:
  ...
  * the first one consists in defining the GAML extensions [in a plug-in](Developing-Plugins) (in the OSGI sense, see [here](http://www.eclipse.org/equinox/)) that will be loaded by GAMA at runtime and must "declare" that it is contributing to the platform.
