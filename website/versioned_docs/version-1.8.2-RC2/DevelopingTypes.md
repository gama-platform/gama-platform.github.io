...
Example (from [GamaFloatType.java](https://github.com/gama-platform/gama.old/tree/GAMA_1.8.2/msi.gama.core/src/msi/gaml/types/GamaFloatType.java)):
```
@type(
	name = IKeyword.FLOAT, 
...
Example (from [GamaColorType.java](https://github.com/gama-platform/gama.old/tree/GAMA_1.8.2/msi.gama.core/src/msi/gaml/types/GamaColorType.java)):
```
...
This annotation contains:
  ...
  * **id** (int, 0 by default): _the unique identifier for this type. User-added types can be chosen between IType.AVAILABLE\_TYPE and IType.SPECIES\_TYPE (exclusive) (cf. [IType.java](https://github.com/gama-platform/gama.old/tree/GAMA_1.8.2/msi.gama.core/src/msi/gaml/types/IType.java))_.
...
All these annotations are defined in the file [GamlAnnotations.java](https://github.com/gama-platform/gama.old/blob/GAMA_1.8.2/ummisco.gama.annotations/src/msi/gama/precompiler/GamlAnnotations.java).
