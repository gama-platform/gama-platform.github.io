...
GAMA 1.9.2  is the current recommended version. This release focuses on bug fixes and internal software improvement. You can find the list of issues solved for this release in the dedicated [github project](https://github.com/orgs/gama-platform/projects/5) as well as a changelog since 1.9.1 in the beginning of [this page](https://gama-platform.org/wiki/Changelog).
