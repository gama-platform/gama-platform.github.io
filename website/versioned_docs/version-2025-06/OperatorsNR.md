...
**See also:** [min_of](OperatorsIM#min_of), [max_of](OperatorsIM#max_of), [sum_of](OperatorsSZ#sum_of), [mean_of](OperatorsIM#mean_of), [variance_of](OperatorsSZ#variance_of), 
...
**See also:** [weighted_means_DM](OperatorsSZ#weighted_means_dm), [electre_DM](OperatorsDH#electre_dm), [evidence_theory_DM](OperatorsDH#evidence_theory_dm), [fuzzy_choquet_DM](OperatorsDH#fuzzy_choquet_dm), 
...
**See also:** [is_property](OperatorsIM#is_property), 
...
**See also:** [around](OperatorsAA#around), [circle](OperatorsBC#circle), [cone](OperatorsBC#cone), [line](OperatorsIM#line), [link](OperatorsIM#link), [norm](OperatorsNR#norm), [point](OperatorsNR#point), [polygon](OperatorsNR#polygon), [polyline](OperatorsNR#polyline), [rectangle](OperatorsNR#rectangle), [square](OperatorsSZ#square), 
...
**See also:** [around](OperatorsAA#around), [circle](OperatorsBC#circle), [cone](OperatorsBC#cone), [line](OperatorsIM#line), [link](OperatorsIM#link), [norm](OperatorsNR#norm), [point](OperatorsNR#point), [polygon](OperatorsNR#polygon), [polyline](OperatorsNR#polyline), [square](OperatorsSZ#square), [triangle](OperatorsSZ#triangle), [cylinder](OperatorsBC#cylinder), [plan](OperatorsNR#plan), [cube](OperatorsBC#cube), [ellipse](OperatorsDH#ellipse), [polyhedron](OperatorsNR#polyhedron), [sphere](OperatorsSZ#sphere), [cone3D](OperatorsBC#cone3d), [teapot](OperatorsSZ#teapot), [squircle](OperatorsSZ#squircle), [elliptical_arc](OperatorsDH#elliptical_arc), [cross](OperatorsBC#cross), [hexagon](OperatorsDH#hexagon), [geometry_collection](OperatorsDH#geometry_collection), [pyramid](OperatorsNR#pyramid), [curve](OperatorsBC#curve), [arc](OperatorsAA#arc), 
...
**See also:** [replace_regex](OperatorsNR#replace_regex), 
...
**See also:** [replace](OperatorsNR#replace), [regex_matches](OperatorsNR#regex_matches), 
...
**See also:** [hsb](OperatorsDH#hsb), [blend](OperatorsBC#blend), [grayscale](OperatorsDH#grayscale), [rnd_color](OperatorsNR#rnd_color), 
...
**See also:** [binomial](OperatorsBC#binomial), [gamma_rnd](OperatorsDH#gamma_rnd), [gauss_rnd](OperatorsDH#gauss_rnd), [lognormal_rnd](OperatorsIM#lognormal_rnd), [poisson](OperatorsNR#poisson), [skew_gauss](OperatorsSZ#skew_gauss), [truncated_gauss](OperatorsSZ#truncated_gauss), [weibull_rnd](OperatorsSZ#weibull_rnd), [rnd_choice](OperatorsNR#rnd_choice), [flip](OperatorsDH#flip), [gauss](OperatorsDH#gauss), 
...
**See also:** [transformed_by](OperatorsSZ#transformed_by), [translated_by](OperatorsSZ#translated_by), 
...
**See also:** [inverse_rotation](OperatorsIM#inverse_rotation), 
...
**See also:** [round](OperatorsNR#round), [int](OperatorsIM#int), [with_precision](OperatorsSZ#with_precision), [floor](OperatorsDH#floor), [ceil](OperatorsBC#ceil), 
...
**See also:** [column_at](OperatorsBC#column_at), [columns_list](OperatorsBC#columns_list), 
...
**See also:** [columns_list](OperatorsBC#columns_list), [column_at](OperatorsBC#column_at), 
