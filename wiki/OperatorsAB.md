...
float var0 <- date('2000-01-01') - date('2010-01-02'); // var0 equals 86400
``` 
...
float var20 <- 1.0 - 1; // var20 equals 0.0 
float var21 <- 3.7 - 1.2; // var21 equals 2.5 
float var22 <- 3 - 1.2; // var22 equals 1.8 
...
date var22 <- date('2000-01-01') + 200; // var22 equals date('2000-01-01')
``` 
