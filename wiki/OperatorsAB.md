...
map var19 <- ['a'::1,'b'::2] - ('c'::3); // var19 equals ['a'::1,'b'::2] 
...
list<int> var0 <- [1,2,3,4,5,6] + [2,4,9]; // var0 equals [1,2,3,4,5,6,2,4,9] 
list<int> var1 <- [1,2,3,4,5,6] + [0,8]; // var1 equals [1,2,3,4,5,6,0,8]
``` 
