...
``` 
list<int> var19 <- [1,2,3,4,5,6,2] - 2; // var19 equals [1,3,4,5,6,2] 
list<int> var20 <- [1,2,3,4,5,6] - 0; // var20 equals [1,2,3,4,5,6]
``` 
...
``` 
point var29 <- {1, 2} - 4.5; // var29 equals {-3.5, -2.5, -4.5} 
point var30 <- {1, 2} - 4; // var30 equals {-3.0,-2.0,-4.0}
``` 
...
``` 
rgb var32 <- rgb([255, 128, 32]) - 3; // var32 equals rgb([252,125,29])
``` 
...
matrix var1 <- (10.0 - (3.0 as_matrix({2,3}))); // var1 equals matrix([[7.0,7.0,7.0],[7.0,7.0,7.0]]) 
...
float var6 <- 3.7 - 1; // var6 equals 2.7 
float var7 <- 3.0 - 1; // var7 equals 2.0 
...
float var12 <- 1 - 1.0; // var12 equals 0.0 
float var13 <- 3 - 1.2; // var13 equals 1.8 
...
``` 
string var18 <- "hello " + "World"; // var18 equals "hello World"
``` 
...
``` 
rgb var23 <- rgb([255, 128, 32]) + rgb('red'); // var23 equals rgb([255,128,32])
``` 
...
``` 
geometry var24 <- line([{10,10}, {50,50}]) + (5,32,#round, true); // var24 equals A ploygon corresponding to the buffer generated
``` 
...
``` 
string var26 <- "hello " + 12; // var26 equals "hello 12"
``` 
