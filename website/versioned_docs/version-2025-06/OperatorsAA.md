...
#### Result: 
If it is used as a unary operator, it returns the opposite of the operand.
...
**See also:** [+](OperatorsAA#+), [*](OperatorsAA#*), [/](OperatorsAA#/), [milliseconds_between](OperatorsIM#milliseconds_between), [-](OperatorsAA#-), [inter](OperatorsIM#inter), 
...
**See also:** [bool](OperatorsBC#bool), [and](OperatorsAA#and), [or](OperatorsNR#or), [xor](OperatorsSZ#xor), 
...
**See also:** [/](OperatorsAA#/), [+](OperatorsAA#+), [-](OperatorsAA#-), [^](OperatorsAA#^), 
...
``` 
geometry var10 <- line([{10,10}, {50,50}]) + (5, true); // var10 equals A ploygon corresponding to the buffer generated
``` 
...
``` 
geometry var23 <- line([{10,10}, {50,50}]) + (5,32,#round, true); // var23 equals A ploygon corresponding to the buffer generated
``` 
...
``` 
point var25 <- {1, 2} + {4, 5}; // var25 equals {5.0, 7.0}
``` 
...
``` 
rgb var26 <- rgb([255, 128, 32]) + rgb('red'); // var26 equals rgb([255,128,32])
``` 
...
``` 
rgb var27 <- rgb([255, 128, 32]) + 3; // var27 equals rgb([255,131,35])
``` 
...
map var8 <- ['a'::1,'b'::2] + ('c'::3); // var8 equals ['a'::1,'b'::2,'c'::3]
```
      


**See also:** [-](OperatorsAA#-), [/](OperatorsAA#/), [*](OperatorsAA#*), [inter](OperatorsIM#inter), [union](OperatorsSZ#union), 
...
**See also:** [asin](OperatorsAA#asin), [atan](OperatorsAA#atan), [cos](OperatorsBC#cos), [atan2](OperatorsAA#atan2), 
...
**See also:** [add_geometry](OperatorsAA#add_geometry), [add_icon](OperatorsAA#add_icon), [add_3Dmodel](OperatorsAA#add_3dmodel), 
...
**See also:** [is_agent](OperatorsIM#is_agent), 
...
**See also:** [agent_closest_to](OperatorsAA#agent_closest_to), [agents_overlapping](OperatorsAA#agents_overlapping), [closest_to](OperatorsBC#closest_to), [inside](OperatorsIM#inside), [overlapping](OperatorsNR#overlapping), [covering](OperatorsBC#covering), [touching](OperatorsSZ#touching), [partially_overlapping](OperatorsNR#partially_overlapping), [agents_at_distance](OperatorsAA#agents_at_distance), [neighbors_at](OperatorsNR#neighbors_at), [agent_farthest_to](OperatorsAA#agent_farthest_to), [crossing](OperatorsBC#crossing), [farthest_to](OperatorsDH#farthest_to), [at_distance](OperatorsAA#at_distance), [neighbors_of](OperatorsNR#neighbors_of), 
...
**See also:** [neighbors_at](OperatorsNR#neighbors_at), [neighbors_of](OperatorsNR#neighbors_of), [agent_closest_to](OperatorsAA#agent_closest_to), [agents_inside](OperatorsAA#agents_inside), [closest_to](OperatorsBC#closest_to), [inside](OperatorsIM#inside), [overlapping](OperatorsNR#overlapping), [at_distance](OperatorsAA#at_distance), [covering](OperatorsBC#covering), [touching](OperatorsSZ#touching), [partially_overlapping](OperatorsNR#partially_overlapping), [agents_crossing](OperatorsAA#agents_crossing), [agent_farthest_to](OperatorsAA#agent_farthest_to), [crossing](OperatorsBC#crossing), [agents_covering](OperatorsAA#agents_covering), [farthest_to](OperatorsDH#farthest_to), [agents_partially_overlapping](OperatorsAA#agents_partially_overlapping), [agents_touching](OperatorsAA#agents_touching), 
...
**See also:** [beta_index](OperatorsBC#beta_index), [gamma_index](OperatorsDH#gamma_index), [nb_cycles](OperatorsNR#nb_cycles), [connectivity_index](OperatorsBC#connectivity_index), [connected_components_of](OperatorsBC#connected_components_of), 
...
**See also:** [bool](OperatorsBC#bool), [or](OperatorsNR#or), [!](OperatorsAA#!), [xor](OperatorsSZ#xor), 
...
#### Result: 
Application of a very light blur kernel that acts like an anti-aliasing filter when applied to an image. If the last argument is > 0,  applies the filter the equivalent number of times. If it is equal or smaller than zero, the image is returned untouched
...
**See also:** [closest_points_with](OperatorsBC#closest_points_with), [farthest_point_to](OperatorsDH#farthest_point_to), [points_at](OperatorsNR#points_at), [centroid](OperatorsBC#centroid), 
...
**See also:** [around](OperatorsAA#around), [cone](OperatorsBC#cone), [line](OperatorsIM#line), [link](OperatorsIM#link), [norm](OperatorsNR#norm), [point](OperatorsNR#point), [polygon](OperatorsNR#polygon), [polyline](OperatorsNR#polyline), [super_ellipse](OperatorsSZ#super_ellipse), [rectangle](OperatorsNR#rectangle), [square](OperatorsSZ#square), [circle](OperatorsBC#circle), [ellipse](OperatorsDH#ellipse), [triangle](OperatorsSZ#triangle), [elliptical_arc](OperatorsDH#elliptical_arc), 
...
**See also:** [circle](OperatorsBC#circle), [cone](OperatorsBC#cone), [line](OperatorsIM#line), [link](OperatorsIM#link), [norm](OperatorsNR#norm), [point](OperatorsNR#point), [polygon](OperatorsNR#polygon), [polyline](OperatorsNR#polyline), [rectangle](OperatorsNR#rectangle), [square](OperatorsSZ#square), [triangle](OperatorsSZ#triangle), [cylinder](OperatorsBC#cylinder), [plan](OperatorsNR#plan), [cube](OperatorsBC#cube), [ellipse](OperatorsDH#ellipse), [polyhedron](OperatorsNR#polyhedron), [sphere](OperatorsSZ#sphere), [cone3D](OperatorsBC#cone3d), [teapot](OperatorsSZ#teapot), [squircle](OperatorsSZ#squircle), [elliptical_arc](OperatorsDH#elliptical_arc), [cross](OperatorsBC#cross), [box](OperatorsBC#box), [hexagon](OperatorsDH#hexagon), [geometry_collection](OperatorsDH#geometry_collection), [pyramid](OperatorsNR#pyramid), [curve](OperatorsBC#curve), [arc](OperatorsAA#arc), 
...
**See also:** [as_intersection_graph](OperatorsAA#as_intersection_graph), [as_distance_graph](OperatorsAA#as_distance_graph), [grid_cells_to_graph](OperatorsDH#grid_cells_to_graph), 
...
**See also:** [as_distance_graph](OperatorsAA#as_distance_graph), [as_edge_graph](OperatorsAA#as_edge_graph), [grid_cells_to_graph](OperatorsDH#grid_cells_to_graph), 
...
**See also:** [matrix](OperatorsIM#matrix), [field_with](OperatorsDH#field_with), [matrix_with](OperatorsIM#matrix_with), 
...
#### Possible uses: 
  * **`as_spatial_graph`** (`graph`) --->  `gama.core.metamodel.topology.graph.ISpatialGraph` 
...
**See also:** [acos](OperatorsAA#acos), [atan](OperatorsAA#atan), [sin](OperatorsSZ#sin), [atan2](OperatorsAA#atan2), 
...
**See also:** [contains_all](OperatorsBC#contains_all), [contains_any](OperatorsBC#contains_any), [index_of](OperatorsIM#index_of), [last_index_of](OperatorsIM#last_index_of), 
...
**See also:** [neighbors_at](OperatorsNR#neighbors_at), [neighbors_of](OperatorsNR#neighbors_of), [agent_closest_to](OperatorsAA#agent_closest_to), [agents_inside](OperatorsAA#agents_inside), [closest_to](OperatorsBC#closest_to), [inside](OperatorsIM#inside), [overlapping](OperatorsNR#overlapping), [agents_at_distance](OperatorsAA#agents_at_distance), [agents_overlapping](OperatorsAA#agents_overlapping), 
...
**See also:** [acos](OperatorsAA#acos), [asin](OperatorsAA#asin), [tan](OperatorsSZ#tan), [atan2](OperatorsAA#atan2), 
