    ...
    <div className="docMainWrapper wrapper">
      ...
      <FlexContainer>
        ...
        <FlexItem>
          ...
          <h1>GAMA 1.8.1 is here !</h1>
            <p>We are excited to announce our latest release: GAMA 1.8.1. It is available for download right away! We have introduced many new features requested by our users and a redesigned website with documentation for both users and developers. </p>
